<title>Administrative Login | Southview Junior School</title>
            ...
            <div class="header-body text-center mb-7 mt-8">
               <div class="row justify-content-center">
                  <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                     <h1 class="text-white">Login as an Admin Member</h1>
            ...
            <div class="row justify-content-center">
               <div class="col-lg-5 col-md-7">
                  <div class="animated fadeInUp">
                     ...
                     <div class="row mt-3">
                        <div class="col-6">
                           <a href="../admin/dashboard.admin.php" class="text-light"><small>Go to Dashboard</small></a>
                        </div>
