<title>Fees | Southview Junior School</title>
      ...
      <div class="container-fluid d-flex align-items-center">
         <div class="row">
            <div class="col-lg-12 col-md-10 mt--2">
               <h1 class="display-2 text-white" data-aos="slide-right" data-aos-duration="1000">Fees Records • Day Scholars</h1>
               <p class="text-white mt-0 mb-2" data-aos="slide-right" data-aos-duration="1500">Text goes here. Text goes here. Text goes here. Text goes here.</p>
      ...
      <div class="row justify-content-center">
         <div class="col-lg-12">
            <p class="text-center mt--5">
               <button class="btn btn-md btn-neutral my-1 text-success" type="button" data-toggle="collapse" data-target="#pre" aria-expanded="false" aria-controls="pre" style="border-radius: 20px;" data-aos="fade-in" data-aos-duration="3000">
               Pre-primary
               </button>
            ...
            <div class="collapse" id="pre">
               <div class="card mb-7">
                  <div class="card-header border-0">
                     <div class="row">
                        <div class="col-8">
                           <h3 class="display-4 mb-0">Pre-primary <t class="text-success">•</t> Fees Records</h3>
                        </div>
            ...
            <div class="collapse" id="grade-1">
               <div class="card mb-7">
                  <div class="card-header border-0">
                     <div class="row">
                        <div class="col-8">
                           <h3 class="display-4 mb-0">Grade 1 <t class="text-success">•</t> Fees Records</h3>
                        </div>
                        <div class="col-12 text-right">
                           <a href="#" class="btn btn-sm btn-success btn-icon" data-toggle="modal" data-target="#modal-form" style="border-radius: 15px;">
                           <span class="btn-inner--icon"><i class="ni ni-cloud-upload-96"></i></span>
            ...
            <div class="collapse" id="grade-2">
               <div class="card mb-7">
                  <div class="card-header border-0">
                     <div class="row">
                        <div class="col-8">
                           <h3 class="display-4 mb-0">Grade 2 <t class="text-success">•</t> Fees Records</h3>
                        </div>
                        <div class="col-12 text-right">
                           <a href="#" class="btn btn-sm btn-success btn-icon" data-toggle="modal" data-target="#modal-form" style="border-radius: 15px;">
                           <span class="btn-inner--icon"><i class="ni ni-cloud-upload-96"></i></span>
            ...
            <div class="collapse" id="grade-3">
               <div class="card mb-7">
                  <div class="card-header border-0">
                     <div class="row">
                        <div class="col-8">
                           <h3 class="display-4 mb-0">Grade 3 <t class="text-success">•</t> Fees Records</h3>
                        </div>
                        <div class="col-12 text-right">
                           <a href="#" class="btn btn-sm btn-success btn-icon" data-toggle="modal" data-target="#modal-form" style="border-radius: 15px;">
                           <span class="btn-inner--icon"><i class="ni ni-cloud-upload-96"></i></span>
            ...
            <div class="collapse" id="grade-4">
               <div class="card mb-7">
                  <div class="card-header border-0">
                     <div class="row">
                        <div class="col-8">
                           <h3 class="display-4 mb-0">Grade 4 <t class="text-success">•</t> Fees Records</h3>
                        </div>
                        <div class="col-12 text-right">
                           <a href="#" class="btn btn-sm btn-success btn-icon" data-toggle="modal" data-target="#modal-form" style="border-radius: 15px;">
                           <span class="btn-inner--icon"><i class="ni ni-cloud-upload-96"></i></span>
